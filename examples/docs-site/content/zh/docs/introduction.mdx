...
- [完成 10 分钟快速开始](/zh/docs/guides/quickstart)，安装并验证所有生成产物。
- [为 Next.js 站点添加 llms.txt](/zh/docs/guides/nextjs-llms-txt)，建立清晰的 AI 内容索引与逐页 Markdown。
- [连接 MCP 客户端](/zh/docs/guides/mcp-integration)，让 Agent 搜索内容或调用经过许可的工具。
- [为 AI 爬虫配置 robots.txt](/zh/docs/guides/robots-txt)，在不削弱正常搜索发现的前提下声明明确的抓取策略。
