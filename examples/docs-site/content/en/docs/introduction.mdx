...
- [Complete the 10-minute quickstart](/en/docs/guides/quickstart) to install and verify the generated outputs.
- [Add llms.txt to a Next.js site](/en/docs/guides/nextjs-llms-txt) to create a clean AI discovery index and per-page Markdown.
- [Connect an MCP client](/en/docs/guides/mcp-integration) when agents need to search content or call approved tools.
- [Configure robots.txt for AI crawlers](/en/docs/guides/robots-txt) to publish an explicit crawling policy without weakening normal search discovery.
