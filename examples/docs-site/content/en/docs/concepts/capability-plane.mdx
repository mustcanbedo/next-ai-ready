...
questions:
  - q: What does the Capability plane produce?
    a: >-
      OpenAPI 3.1, tools.json, ai-plugin.json, MCP tools, and POST
      /api/actions/<name> endpoints.
  - q: How do I define a callable feature?
    a: >-
      Use defineAction with Zod input/output schemas, then run next-ai-ready
      build to expose it to agents.
tags:
  - architecture
  - knowledge-plane
  - capability-plane
