...
> **Release channel:** this site tracks `main`; npm currently serves `0.1.0-alpha.14`. Its complete internal dependency chain passed a clean registry install, CLI workflow, and Next.js 15 production build on August 2, 2026.
