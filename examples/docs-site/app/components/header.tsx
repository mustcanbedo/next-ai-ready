    ...
    <header className="sticky top-0 z-50 border-b border-border bg-surface/80 backdrop-blur-sm">
      <div className="mx-auto flex h-14 max-w-6xl items-center justify-between px-6">
        <div className="flex items-center gap-6">
          <Link
            href="/"
            className="flex items-center gap-2 text-sm font-semibold text-text hover:text-text/80 transition-colors"
          >
            <span className="inline-flex h-6 w-6 items-center justify-center rounded bg-accent text-[10px] font-bold text-white">
              ai
            </span>
            next-ai-ready
          </Link>
        ...
        <div className="flex items-center gap-4">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="text-xs font-mono text-text-tertiary hover:text-text transition-colors"
          >
            npm
          </a>
        </div>
