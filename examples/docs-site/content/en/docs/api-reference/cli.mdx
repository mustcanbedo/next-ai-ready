...
In report schema v1, agent missing-page recovery is an advisory check with zero
score weight, so adding it does not break an existing CI gate. Audit v2 will make
it part of a separately versioned standards score.
