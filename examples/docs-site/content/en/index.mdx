...
This documentation site tracks `main` and currently targets the `0.1.0-alpha.18` repository candidate. Public availability is determined by npm dist-tags, not by the repository version. Alpha.18 adds deterministic `llms.txt` freshness to the runtime and audit surface documented here.
