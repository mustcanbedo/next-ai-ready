...
> 当前主分支基线：`abe10f4`（PR #35 已合并，合并后 CI 全部通过）
> 待发布变更：统一页面搜索 Provider、双语搜索意图评测、类型化爬虫策略与 Audit v3 判断；候选包为 `next-ai-ready@alpha.20`、`@next-ai-ready/next@alpha.20`、`@next-ai-ready/mcp@alpha.17` 和 `@next-ai-ready/semantic@alpha.15`
