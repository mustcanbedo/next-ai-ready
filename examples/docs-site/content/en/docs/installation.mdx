...
> **Release channel:** this site tracks `main`; npm currently serves `0.1.0-alpha.14`. On August 2, 2026, it passed clean public-registry installs, the CLI workflow, and production builds across npm/pnpm × Next.js 14/15/16. The authenticated production MCP endpoint also passed initialize and all three page discovery calls.
