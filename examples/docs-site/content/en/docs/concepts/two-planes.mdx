...
questions:
  - q: What are the Knowledge and Capability planes?
    a: >-
      Knowledge makes content AI-readable (llms.txt, Markdown, JSON-LD).
      Capability makes features AI-callable (OpenAPI, MCP, actions).
  - q: Why are the planes separate?
    a: >-
      Content ingestion and tool execution have different consumers, security
      models, and build steps.
tags:
  - architecture
  - knowledge-plane
  - capability-plane
