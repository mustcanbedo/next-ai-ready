...
questions:
  - q: What happens during next-ai-ready build?
    a: >-
      Load config, scan MDX, compile semantic nodes, load actions, assemble the
      graph, and write public/ plus .next-ai-ready/ artifacts.
  - q: Is the build deterministic?
    a: >-
      Yes. Same source tree and config produce byte-identical graph and llms
      output, suitable for CI diffing.
tags:
  - architecture
  - knowledge-plane
  - capability-plane
