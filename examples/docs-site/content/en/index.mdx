...
This documentation site tracks `main`, while npm currently serves `0.1.0-alpha.15`. The published package includes TypeScript `next.config.ts` compatibility, focused runtime exports, Audit v3, and MCP page discovery documented here.
