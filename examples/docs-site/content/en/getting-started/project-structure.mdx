...
- `instrumentation.ts` — Next.js instrumentation hook. Use `registerAiHooks()` here to track AI bot requests and action invocations. See [Analytics](/docs/guides/analytics).
