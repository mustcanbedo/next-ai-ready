...
const EXTRA_EXPORTS = [
  ...
  { name: "next-ai-ready", dir: join(ROOT, "packages", "meta"), key: "./search", js: "search.js", dts: "search.d.ts" },
  ...
  { name: "@next-ai-ready/semantic", dir: join(ROOT, "packages", "semantic"), key: "./search", js: "search.js", dts: "search.d.ts" },
];
