...
order: 8
questions:
  - q: What is i18n and AI-friendly URLs?
    a: >-
      Middleware, locale prefixes, and SemanticGraph routes for multilingual
      sites.
  - q: What will I learn from i18n and AI-friendly URLs?
    a: >-
      Middleware, locale prefixes, and SemanticGraph routes for multilingual
      sites.
tags:
