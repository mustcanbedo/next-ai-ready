...
questions:
  - q: What are ADRs in this project?
    a: >-
      Architecture Decision Records documenting why the framework chose specific
      designs over alternatives.
  - q: Are ADRs normative for users?
    a: >-
      They explain intent and trade-offs; the API reference and doctor checks
